...
// This page displays admin actions from localStorage key 'audit-logs'.
// User audit logs are in a separate table at /admin/user-audit-logs (key: 'user-audit-logs').
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-4 flex gap-4">
        <Link href="/admin/user-audit-logs" className="underline text-blue-600 hover:text-blue-800">View User Audit Logs</Link>
      </div>
      <div className="mb-8">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {filtered.length > 0 ? filtered.slice(-sliderValue).reverse().map((log, idx) => (
                ...
                <tr><td colSpan={8} className="p-2 text-gray-400">No audit logs found.</td></tr>
              )}
            </tbody>
          </table>
        </div>
